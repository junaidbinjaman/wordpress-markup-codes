...
@section('content')
    <div class="w-[1340px] mx-auto">
        <div>
            ...
            <div class="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[138px] w-[1350px] mx-auto">
            ...
            <div class="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[138px]">
                <div
                    class="rounded-2xl p-[30px] md:py-[53px] md:px-[48px] gap-5 mx-auto bg-orange-100 px-[15px] py-[50px] md:flex md:px-[52px] md:py-[72px] lg:gap-[40px] lg:h-[420px] xl:h-[390px] max-w-[1190px]">
                        ...
                        <form class="mt-[30px]" action="/">
                            <div class="bg-white flex items-center justify-between p-3 rounded-[55px]">
                                ...
                                <button class="rounded-full bg-green-900 grid place-items-center w-[56px] h-[56px]"
                                        type="submit"><img class="filter-white"
                    ...
                    <div class="relative flex-1"><img
                            ...
                            src="./assets/images/chart.png" alt="Agon">
                    </div>
                </div>
            </div>
            <div
