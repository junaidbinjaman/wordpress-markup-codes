...
<div id="accordion-color" data-accordion="collapse" data-active-classes="bg-gray-100 dark:bg-gray-100 text-blue-600 dark:text-gray-700">
    <h2 id="accordion-color-heading-1">
        <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl dark:border-gray-200 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-200 gap-3" data-accordion-target="#accordion-color-body-1" aria-expanded="true" aria-controls="accordion-color-body-1">
