<div class="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[138px]">
    <div
        class="rounded-2xl p-[30px] md:px-[48px] gap-5 mx-auto bg-orange-100 px-[15px] py-[50px] md:flex md:py-[72px] lg:gap-[40px] lg:h-[420px] xl:h-[390px] max-w-[1190px]">
        ...
        <div class="relative flex-1">
            ...
            <img
                ...
                src="{{asset('images/chart.png')}}" alt="Agon">
        </div>
    </div>
</div>
